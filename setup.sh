...
CUSTOM_CONFIG_COMMANDS_DIR=$CUSTOM_CONFIG_DIR/commands
...
CUSTOM_CONFIG_LOCAL_DIR=$CUSTOM_CONFIG_DIR/local
...
CUSTOM_CONFIG_PACKAGES_DIR=$CUSTOM_CONFIG_DIR/packages
if [ ! -d $CUSTOM_CONFIG_PACKAGES_DIR ]
then
  unset CUSTOM_CONFIG_PACKAGES_DIR
fi

CUSTOM_CONFIG_TERMINAL_DIR=$CUSTOM_CONFIG_DIR/terminal
